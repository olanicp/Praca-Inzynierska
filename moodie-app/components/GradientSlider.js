  ...
  return (
    <View
      style={[
        ...
        { width: sliderWidth + 50, height: sliderHeight },
        transformation,
      ]}
    >
      <View
        style={[styles.track, { width: sliderWidth, height: sliderHeight }]}
      ...
      >
        <LinearGradient
          ...
          style={[
            styles.sliderContainer,
            { width: sliderWidth + 50, height: sliderHeight, borderRadius },
          ]}
        />
        <View
          style={[
        ...
        >
          {marks.map((mark) => {
            ...
            return isVertical ? (
              ...
              <View
                key={mark}
                style={[styles.mark, { left: mark * stepWidth }]}
              >
                <View
                  style={[
                    styles.markLine,
                ...
                />
                <Text style={[styles.numbers, isNumbers ? {} : { right: 25 }]}>
                  {isNumbers
                    ? mark === stepCount
                      ? "10+"
                      : mark
